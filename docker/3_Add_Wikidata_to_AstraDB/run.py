...
from wikidataLangDB import Session, WikidataLang
    ...
    with tqdm(total=total_entities-OFFSET) as progressbar:
        with Session() as session:
            ...
            for entity in entity_generator:
                ...
                tqdm.write(progressbar.format_meter(progressbar.n, progressbar.total, progressbar.format_dict["elapsed"])) # tqdm is not working in docker compose. This is the alternative
