    ...
    with (urlopen(in_filepath) as stream, bz2.BZ2File(stream) as file):
        ...
        for k_iter, line in pbar:
            ...
            if n_complete is not None and n_items > n_complete:
                if None not in [embedder, batchsize] and len(dict_list):
            ...
            dict_list_ = entity_to_statements(
                ...
                embedder=embedder if batchsize is None else None,
            ...
            if batchsize is not None and n_dicts < batchsize:
                # If dict_list len is less than batchsize
...
def process_wikidata_dump(
        ...
        embedder=None, batchsize=None, lang='en', n_complete=None,
